            ...
            <View style={{ flex: 1 }}>
                ...
                <View style={{ flexDirection: 'row', paddingHorizontal: SIZES.radius, height: 80, alignItems: 'flex-end' }}>
                    ...
                    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
                        <Text style={{ ...FONTS.h3, color: book.navTintColor }}>Movie Detail</Text>
                    </View>
                ...
                >
                    ...
                    <View style={{ flex: 1, paddingHorizontal: SIZES.radius, alignItems: 'center' }}>
                        <Text style={{ ...FONTS.h3, color: COLORS.white }}>{book.duration}</Text>
                        <Text style={{ ...FONTS.body4, color: COLORS.white }}>Duration</Text>
                    </View>
    ...
    function renderBottomButton() {
        ...
        return (
            ...
            <View style={{ flex: 1, flexDirection: 'row' }}>
                ...
                >
                    <Text style={{ ...FONTS.h3, color: COLORS.white }}>Add Comment</Text>
                </TouchableOpacity>
                <Comment
                    title="Add Comment"
