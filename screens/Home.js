...
const Home = ({ navigation }) => {
    ...
    const bookTheMetropolis = {
        id: 2,
        bookName: "three billboards outside ebbing missouri",
    ...
    const categoriesData = [
        {
            ...
            books: [
                bookOtherWordsForHome, bookTheMetropolis, bookTheTinyDragon, inception
            ]
        },
        {
            id: 2,
            ...
            <View style={{ flex: 1, flexDirection: 'row', paddingHorizontal: SIZES.padding, alignItems: 'center' }}>
                ...
                >
                    <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                        ...
                        style={{ marginLeft: SIZES.base, color: COLORS.white, ...FONTS.body3 }}>WatchList </Text>
                ...
                <View style={{ flexDirection: 'row', height: 70, backgroundColor: COLORS.secondary, borderRadius: SIZES.radius }}>
                    ...
                    >
                        <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                            ...
                            />
                            <Text style={{ marginLeft: SIZES.base, ...FONTS.body3, color: COLORS.white }}>Lists</Text>
                        </View>
                    </TouchableOpacity>
                    ...
                    >
                        ...
                        >
                            ...
                            />
                            <Text style={{ marginLeft: SIZES.base, ...FONTS.body3, color: COLORS.white }}>Diary</Text>
                        </View>
                    </TouchableOpacity>
                </View>
            </View>
        ...
        return (
            <View style={{ flex: 1 }}>
                ...
                <View style={{ paddingHorizontal: SIZES.padding, flexDirection: 'row', justifyContent: 'space-between' }}>
                    <Text style={{ ...FONTS.h2, color: COLORS.white }}>My Movies</Text>
